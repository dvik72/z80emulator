...
export class MsxTrBase extends Machine {
  ...
  public getFrameBufferWidth(): number | null {
    return this.vdp && this.vdp.getFrameBufferWidth() || null;
  }

  public getFrameBufferHeight(): number | null {
    return this.vdp && this.vdp.getFrameBufferHeight() || null;
  }
