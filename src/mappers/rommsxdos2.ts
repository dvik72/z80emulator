...
export class MapperRomMsxDos2 extends Mapper {
  static NAME = 'MSXDOS2';

  constructor(board: Board, slot: number, sslot: number, romData: Uint8Array) {
    super(MapperRomMsxDos2.NAME);
